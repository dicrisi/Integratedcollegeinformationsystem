...
<div class="container">
	...
	<form action="" method="post" enctype="multipart/form-data" name="addroom">
		...
		<table align="center">
			<tr>
				<td><b>Id</b></td>
				<td><input name="fid" type="text" value="<?php echo $row['fid'] ?>" readonly/></td>
			</tr>
			<tr>
				<td><b> Fest Name</b></td>
				<td><input name="fname" type="text" value="<?php echo $row['fname'] ?>" readonly/></td>
			</tr>
	...
	<?php
		if(isset($_POST['submit'])){
			...
			(null,'".$_POST['fid']."','".$_POST['fname']."','".$_POST['regno']."','".$_POST['name']."','".$_POST['dat']."','workshop')";
